...
**Requirements:**
The models hosted in this repository need Python (version3; https://www.python.org/downloads/source/) and CDO (version1.9; https://code.mpimet.mpg.de/projects/cdo/). The package also requires installation of the Python packages: Cf-Python (https://ncas-cms.github.io/cf-python/), Numpy (http://www.numpy.org), Pandas (https://pandas.pydata.org/), SciPy (https://scipy.org/) and CDSAPI (https://cds.climate.copernicus.eu/api-how-to)
